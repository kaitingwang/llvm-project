...
module {
    ...
    affine.for %arg12 = 0 to %4 {
      affine.for %arg13 = 0 to %0 {
        ...
        affine.for %arg14 = 0 to %1 {
          %5 = affine.load %arg6[%arg12, %arg14] {set = 1, reorder}: memref<1600x2000xf64>
          %6 = affine.load %arg7[%arg14, %arg13] {set = 1, reorder}: memref<2000x1800xf64>
          %7 = arith.mulf %5, %6 {set = 1, reorder}: f64
          %8 = affine.load %arg5[%arg12, %arg13] {set = 1, reorder}: memref<1600x1800xf64>
          %9 = arith.addf %8, %7 {set = 1, reorder}: f64
          affine.store %9, %arg5[%arg12, %arg13] {set = 1, reorder}: memref<1600x1800xf64>
        } {reorderLoop11}
      } {reorderLoop12}
    } {distribute1}
    ...
    affine.for %arg12 = 0 to %0 {
      affine.for %arg13 = 0 to %2 {
        ...
        affine.for %arg14 = 0 to %3 {
          %5 = affine.load %arg9[%arg12, %arg14] {set = 1, reorder}: memref<1800x2400xf64>
          %6 = affine.load %arg10[%arg14, %arg13] {set = 1, reorder}: memref<2400x2200xf64>
          %7 = arith.mulf %5, %6 {set = 1, reorder}: f64
          %8 = affine.load %arg8[%arg12, %arg13] {set = 1, reorder}: memref<1800x2200xf64>
          %9 = arith.addf %8, %7 {set = 1, reorder}: f64
          affine.store %9, %arg8[%arg12, %arg13] {set = 1, reorder}: memref<1800x2200xf64>
        } {reorderLoop21}
      } {reorderLoop22}
    } {distribute2}
    ...
    affine.for %arg12 = 0 to %4 {
      affine.for %arg13 = 0 to %2 {
        ...
        affine.for %arg14 = 0 to %0 {
          %5 = affine.load %arg5[%arg12, %arg14] {set = 1, reorder}: memref<1600x1800xf64>
          %6 = affine.load %arg8[%arg14, %arg13] {set = 1, reorder}: memref<1800x2200xf64>
          %7 = arith.mulf %5, %6 {set = 1, reorder}: f64
          %8 = affine.load %arg11[%arg12, %arg13] {set = 1, reorder}: memref<1600x2200xf64>
          %9 = arith.addf %8, %7 {set = 1, reorder}: f64
          affine.store %9, %arg11[%arg12, %arg13] {set = 1, reorder}: memref<1600x2200xf64>
        } {reorderLoop31}
      } {reorderLoop32}
    } {distribute3}
    return
 ...
 transform.sequence failures(propagate) {
  ^bb1(%arg1: !transform.any_op):
    ...
    %5 = transform.structured.match ops{["affine.for"]} attributes {reorderLoop31} in %arg1 : (!transform.any_op) -> !transform.op<"affine.for">
    %6 = transform.structured.match ops{["affine.for"]} attributes {reorderLoop32} in %arg1 : (!transform.any_op) -> !transform.op<"affine.for">
    transform.validator.partial_reorder %5 and %6  : (!transform.op<"affine.for">, !transform.op<"affine.for">) -> ()
    ...
    %42 = transform.validator.parallel %35 : (!transform.op<"affine.for">) -> !transform.op<"affine.for">
