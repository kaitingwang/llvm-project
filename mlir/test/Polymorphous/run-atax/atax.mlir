...
module attributes {llvm.data_layout = "", llvm.target_triple = ""}  {
   func.func private @atax(%arg0: i32, %arg1: i32, %arg2: memref<?x42xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>) {
     ...
     affine.for %arg6 = 0 to %1 {
       ...
       affine.for %arg7 = 0 to %0 {
         %2 = affine.load %arg5[%arg6] {set = 1}: memref<?xf64>
         %3 = affine.load %arg2[%arg6, %arg7] {set = 1}: memref<?x42xf64>
         %4 = affine.load %arg3[%arg7] {set = 1}: memref<?xf64>
         %5 = arith.mulf %3, %4 {set = 1}: f64
         %6 = arith.addf %2, %5 {set = 1}: f64
         affine.store %6, %arg5[%arg6] {set = 1}: memref<?xf64>
       } 
       affine.for %arg7 = 0 to %0 {
         %2 = affine.load %arg4[%arg7] {set = 2}: memref<?xf64>
         %3 = affine.load %arg2[%arg6, %arg7] {set = 2}: memref<?x42xf64>
         %4 = affine.load %arg5[%arg6] {set = 2}: memref<?xf64>
         %5 = arith.mulf %3, %4 {set = 2}: f64
         %6 = arith.addf %2, %5 {set = 2}: f64
         affine.store %6, %arg4[%arg7] {set = 2}: memref<?xf64>
       } 
     } {distribute}
     return
   }
   ...
   ^bb1(%arg1: !transform.any_op):
    ...
    %parallel2 = transform.validator.parallel %reorder2#1 : (!transform.op<"affine.for">) -> !transform.op<"affine.for">

    transform.validator.unroll %tiled#2 { factor = 8 } : (!transform.op<"affine.for">) -> !transform.op<"affine.for">
